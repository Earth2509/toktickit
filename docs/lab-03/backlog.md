...
Status: First issue created as [#34](https://github.com/Earth2509/toktickit/issues/34). Remaining rows are proposed backlog, not claims of GitHub Issue creation or completion.
...
| 2 | Lab 3: User migration and authentication foundation | Safe migration/provisioning/seed, sessions/password/login/logout/me and DB tests | 1 approved |
...
| 7 | Lab 3: Minimal Administrator User Management | User search/create/edit/reset, role/activation safety and tests | 3,5 |
