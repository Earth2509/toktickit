...
| API-01 | API | AC-01 | Active valid login returns safe user and cookie; unknown/wrong/inactive login identical 401; no hash/token in JSON | server/tests/lab-03/auth.api.test.ts | Planned |
...
| API-03 | API | AC-02 | Pending sessions can use me/change/logout only; business routes deny until valid change; failed change preserves gate | server/tests/lab-03/auth.api.test.ts | Planned |
...
| API-08 | API/integration | AC-07 | Valid upload/download/removal; MIME,size,count,association,removed download and terminal mutation restrictions; file/metadata consistency | server/tests/lab-03/requester-regression.api.test.ts | Planned |
...
| DB-02 | Migration/integration | AC-06 | Email collision preflight stops safely; provision/seed twice does not duplicate or overwrite passwords/edits; minimum role fixtures exist | server/tests/lab-03/migration.test.ts | Planned |
...
| API-10 | API/integration | AC-09 | Claim only unassigned; active permitted assignment/null; inactive/wrong-role rejection; two concurrent claims have one winner/event | server/tests/lab-03/staff-ticket-detail.api.test.ts | Planned |
| API-11 | API | AC-10 | IT priority backfill/create equality, immutable requested priority, permitted edit, terminal denial, role denial | server/tests/lab-03/staff-ticket-detail.api.test.ts | Planned |
| API-12 | API/integration | AC-11 | Parameterize all 8x8 transitions with allowed/denied role, version, owner and reason/summary rules; rollback event on failed update | server/tests/lab-03/staff-ticket-detail.api.test.ts | Planned |
| API-13 | API | AC-05,AC-12 | Public/internal visibility matrix; author spoof rejection; empty/2000/2001 content; safe HTML rendering payload; no editing/deletion; terminal rule | server/tests/lab-03/comments-notes.api.test.ts | Planned |
...
| API-15 | API | AC-14 | Admin list/search/create/edit; normalized duplicate email; invalid role/name/password; non-Admin denied; safe DTO | server/tests/lab-03/users-admin.api.test.ts | Planned |
...
| UI-02 | UI | AC-02,AC-16 | Password gate, match/rules/busy/failure and successful role landing | client/tests/lab-03/ChangePassword.test.tsx | Planned |
...
| UI-05 | UI | AC-09,AC-10,AC-11,AC-12 | Staff edit/read-only separation, confirmations, private/public draft separation, busy/conflict/failure and terminal controls | client/tests/lab-03/StaffTicketDetail.test.tsx | Planned |
...
| UI-07 | UI | AC-14,AC-15,AC-16 | Users create/edit/search/reset, validation/safety/forbidden/success, retained fields after failure | client/tests/lab-03/UserManagement.test.tsx | Planned |
...
| E2E-01 | E2E | AC-01,AC-02,AC-03 | Real login initial change, role landing, logout then direct route/API denial | e2e/lab-03/authentication.spec.ts | Planned |
| E2E-02 | E2E | AC-08,AC-09,AC-10,AC-11,AC-12,AC-13 | Real staff claim/priority/progress/public/internal exchange with Requester, indication then staff resolution/close | e2e/lab-03/staff-ticket-flow.spec.ts | Planned |
