...
| API-13 | API | AC-05,AC-12 | Public/internal visibility matrix; author spoof rejection; empty/2000/2001 content; creation allowed RESOLVED but denied CLOSED/CANCELLED per table; newest-first stable pagination and unknown query rejection | server/tests/lab-03/comments-notes.api.test.ts | Passed |
