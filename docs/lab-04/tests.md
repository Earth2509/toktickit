...
| UNIT-01 | Unit | AC-01, AC-02, AC-05 | Validate Action status/assignee/follow-up transitions and pure resolution-gate decisions | `server/tests/lab-04/actions-taken.unit.test.ts` | Planned |
...
| PERF-01 | Performance smoke | AC-06, AC-07 | Seed a representative dashboard dataset and confirm both dashboard endpoints complete within the documented local smoke threshold | `server/tests/lab-04/dashboard-performance.smoke.test.ts` | Planned |
