...
export default function StaffTicketQueue() {
  ...
  return <section className="ticket-card ticket-list-card" aria-labelledby="staff-queue-heading">
    <div className="ticket-card-heading"><div><p className="section-kicker">IT Staff workspace</p><h1 id="staff-queue-heading">Ticket Queue</h1><p>Review the service queue. Ticket changes are delivered in the next workflow issue.</p></div></div>
